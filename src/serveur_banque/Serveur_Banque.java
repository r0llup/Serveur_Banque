...
/**
 * Manage a {@link Serveur_Banque}
 * @author Sh1fT
 */
public class Serveur_Banque extends JDialog {
    private ProtocolMAMP protocolMAMP;
    private DemarrerServeur2 demarrerServeur2;
    private PropertiesLauncher propertiesLauncher;

    /**
     * Create a new {@link Serveur_Banque} instance
     * @param parent
     * @param modal 
     */
    public Serveur_Banque(Frame parent, boolean modal) {
        super(parent, modal);
        this.initComponents();
        this.setProtocolMAMP(new ProtocolMAMP(this));
        ...
        this.setPropertiesLauncher(new PropertiesLauncher(
                ...
                System.getProperty("file.separator") + "Serveur_Banque.properties"));
    }

    public ProtocolMAMP getProtocolMAMP() {
        return protocolMAMP;
    }

    public void setProtocolMAMP(ProtocolMAMP protocolMAMP) {
        this.protocolMAMP = protocolMAMP;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Serveur_Banque dialog = new Serveur_Banque(new javax.swing.JFrame(), true);
